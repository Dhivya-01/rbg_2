...
//         <Route path="/DhvaniPage" element={<DhvaniPage/>}/>
//         <Route path="/Loops" element={<Loops/>}/>
//         <Route path="/Deed" element ={<Deed/>}/>
//         <Route path="/Stack" element ={<Stack/>}/>
//         <Route path="/KVoice" element ={<KVoice/>}/>
//         <Route path="/Terms" element ={<Terms/>}/>
//         <Route pathh="/FormExtraction" element={<FormExtraction/>}/>
//         <Route path="/CaptchaResolving" element={<Captcha/>}/>
//       </Route>
